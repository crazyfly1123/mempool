...
void calc_axpy_parallel(int32_t *matrix_X, int32_t *matrix_Y, int32_t alpha,
                        uint32_t elements, uint32_t core_id,
                        uint32_t num_cores) {
...
void calc_axpy_parallel_unloop(int32_t *matrix_X, int32_t *matrix_Y,
                               int32_t alpha, uint32_t elements,
...
void calc_axpy_parallel_unloop_x4_localbank(int32_t *matrix_X,
                                            int32_t *matrix_Y, int32_t alpha,
                                            uint32_t elements, uint32_t core_id,
                                            uint32_t num_cores) {
